...
# Import functions from biome_wfc
from biome_wfc import biome_wfc_step, find_lowest_entropy_cell, initialize_wfc_grid
...
class WFCWrapper(gym.Env):
    ...
    def get_observation(self) -> np.ndarray:
        ...
        pos_tuple = find_lowest_entropy_cell(self.grid)
...
if __name__ == "__main__":
    ...
    # Load adjacency rules and tile images
