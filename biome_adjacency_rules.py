...
TILES = {
    ...
    "grass": {
        "edges": {
            ...
            "L": ["grass", "tall_grass", "sand_tr", "sand_r", "sand_br", "water_tr", "water_r", "water_br", "flower", "grass_hill_r", "grass_hill_br"], 
            "R": ["grass", "tall_grass", "sand_tl", "sand_l", "sand_bl", "water_tl", "water_l", "water_bl", "flower", "grass_hill_l", "grass_hill_bl"],
        },
