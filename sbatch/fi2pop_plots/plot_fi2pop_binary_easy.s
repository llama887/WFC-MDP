#!/bin/bash
#SBATCH --job-name=plot_binary_easy_fi2pop
#SBATCH --output=plot_binary_easy_fi2pop_%j.out
#SBATCH --error=plot_binary_easy_fi2pop_%j.err
...
python plot.py --load-hyperparameters hyperparameters/fi2pop_binary_hyperparameters.yaml --task binary_easy --method fi2pop
