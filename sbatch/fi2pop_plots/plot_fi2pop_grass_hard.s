#!/bin/bash
#SBATCH --job-name=plot_grass_hard_fi2pop
#SBATCH --output=plot_grass_hard_fi2pop_%j.out
#SBATCH --error=plot_grass_hard_fi2pop_%j.err
...
python plot.py --load-hyperparameters hyperparameters/fi2pop_combo_grass_hyperparameters.yaml --task grass --combo hard --method fi2pop
