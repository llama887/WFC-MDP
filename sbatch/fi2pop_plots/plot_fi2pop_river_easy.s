#!/bin/bash
#SBATCH --job-name=plot_river_easy_fi2pop
#SBATCH --output=plot_river_easy_fi2pop_%j.out
#SBATCH --error=plot_river_easy_fi2pop_%j.err
...
python plot.py --load-hyperparameters hyperparameters/fi2pop_combo_river_hyperparameters.yaml --task river --combo easy --debug --method fi2pop
