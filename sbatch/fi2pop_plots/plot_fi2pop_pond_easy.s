#!/bin/bash
#SBATCH --job-name=plot_pond_easy_fi2pop
#SBATCH --output=plot_pond_easy_fi2pop_%j.out
#SBATCH --error=plot_pond_easy_fi2pop_%j.err
...
python plot.py --load-hyperparameters hyperparameters/fi2pop_combo_pond_hyperparameters.yaml --task pond --combo easy --debug --method fi2pop
