#!/bin/bash
#SBATCH --job-name=plot_biomes_fi2pop
#SBATCH --output=plot_biomes_fi2pop_%j.out
#SBATCH --error=plot_biomes_fi2pop_%j.err
...
python plot.py --load-hyperparameters hyperparameters/fi2pop_biomes_hyperparameters.yaml --task biomes --method fi2pop
