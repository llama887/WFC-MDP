#!/bin/bash
#SBATCH --job-name=hyperparams_combo_river_mcts
#SBATCH --output=hyperparams_combo_river_mcts_%j.out
#SBATCH --error=hyperparams_combo_river_mcts_%j.err
...
python core/mcts.py --iterations-per-trial 500 --hyperparameter-dir hyperparameters --output-file mcts_combo_river_hyperparameters.yaml --task binary_hard --task river --optuna-trials 5
