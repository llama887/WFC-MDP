#!/bin/bash
#SBATCH --job-name=hyperparams_combo_pond_fi2pop
#SBATCH --output=hyperparams_combo_pond_fi2pop_%j.out
#SBATCH --error=hyperparams_combo_pond_fi2pop_%j.err
...
python core/fi2pop.py --generations-per-trial 100 --hyperparameter-dir hyperparameters --output-file fi2pop_combo_pond_hyperparameters.yaml --task binary_hard --task pond --optuna-trials 20
