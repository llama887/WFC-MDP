#!/bin/bash
#SBATCH --job-name=hyperparams_combo_hill_fi2pop
#SBATCH --output=hyperparams_combo_hill_fi2pop_%j.out
#SBATCH --error=hyperparams_combo_hill_fi2pop_%j.err
...
python core/fi2pop.py --generations-per-trial 500 --hyperparameter-dir hyperparameters --output-file fi2pop_combo_hill_hyperparameters.yaml --task binary_hard --task hill --optuna-trials 5
