#!/bin/bash
#SBATCH --job-name=hyperparams_combo_pond_2d
#SBATCH --output=hyperparams_combo_pond_2d_%j.out
#SBATCH --error=hyperparams_combo_pond_2d_%j.err
...
python core/evolution.py --generations-per-trial 100 --hyperparameter-dir hyperparameters --output-file combo_pond_2d_hyperparameters.yaml --task binary_hard --task pond --optuna-trials 20 --genotype-dimensions 2
