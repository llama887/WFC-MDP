#!/bin/bash
#SBATCH --job-name=hyperparams_combo_grass_baseline
#SBATCH --output=hyperparams_combo_grass_baseline_%j.out
#SBATCH --error=hyperparams_combo_grass_baseline_%j.err
...
python core/fi2pop.py --mode baseline --generations-per-trial 500 --hyperparameter-dir hyperparameters --output-file baseline_combo_grass_hyperparameters.yaml --task binary_hard --task grass --optuna-trials 5
