#!/bin/bash
#SBATCH --job-name=hyperparams_combo_hill_1d
#SBATCH --output=hyperparams_combo_hill_1d_%j.out
#SBATCH --error=hyperparams_combo_hill_1d_%j.err
...
python core/evolution.py --generations-per-trial 100 --hyperparameter-dir hyperparameters --output-file combo_hill_1d_hyperparameters.yaml --task binary_hard --task hill --optuna-trials 20
