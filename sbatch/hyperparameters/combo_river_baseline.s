#!/bin/bash
#SBATCH --job-name=hyperparams_combo_river_baseline
#SBATCH --output=hyperparams_combo_river_baseline_%j.out
#SBATCH --error=hyperparams_combo_river_baseline_%j.err
...
python core/fi2pop.py --mode baseline --generations-per-trial 100 --hyperparameter-dir hyperparameters --output-file baseline_combo_river_hyperparameters.yaml --task binary_hard --task river --optuna-trials 20
