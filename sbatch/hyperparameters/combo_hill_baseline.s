#!/bin/bash
#SBATCH --job-name=hyperparams_combo_hill_baseline
#SBATCH --output=hyperparams_combo_hill_baseline_%j.out
#SBATCH --error=hyperparams_combo_hill_baseline_%j.err
...
python core/fi2pop.py --mode baseline --generations-per-trial 500 --hyperparameter-dir hyperparameters --output-file baseline_combo_hill_hyperparameters.yaml --task binary_hard --task hill --optuna-trials 5
