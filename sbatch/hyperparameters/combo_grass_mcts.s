#!/bin/bash
#SBATCH --job-name=hyperparams_combo_grass_mcts
#SBATCH --output=hyperparams_combo_grass_mcts_%j.out
#SBATCH --error=hyperparams_combo_grass_mcts_%j.err
...
python core/mcts.py --iterations-per-trial 500 --hyperparameter-dir hyperparameters --output-file mcts_combo_grass_hyperparameters.yaml --task binary_hard --task grass --optuna-trials 5
