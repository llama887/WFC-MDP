#!/bin/bash
#SBATCH --job-name=hyperparams_binary_baseline
#SBATCH --output=hyperparams_binary_baseline_%j.out
#SBATCH --error=hyperparams_binary_baseline_%j.err
...
python core/fi2pop.py --mode baseline --generations-per-trial 100 --hyperparameter-dir hyperparameters --output-file baseline_binary_hyperparameters.yaml --task binary_hard --optuna-trials 20
