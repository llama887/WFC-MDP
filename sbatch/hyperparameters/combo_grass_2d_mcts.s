#!/bin/bash
#SBATCH --job-name=hyperparams_combo_grass_2d_mcts
#SBATCH --output=hyperparams_combo_grass_2d_mcts_%j.out
#SBATCH --error=hyperparams_combo_grass_2d_mcts_%j.err
...
python core/mcts.py --generations-per-trial 100 --hyperparameter-dir hyperparameters --output-file mcts_combo_grass_2d_hyperparameters.yaml --task binary_hard --task grass --optuna-trials 20 --genotype-dimensions 2
