#!/bin/bash
#SBATCH --job-name=hyperparams_combo_river_1d_mcts
#SBATCH --output=hyperparams_combo_river_1d_mcts_%j.out
#SBATCH --error=hyperparams_combo_river_1d_mcts_%j.err
...
python core/mcts.py --generations-per-trial 100 --hyperparameter-dir hyperparameters --output-file mcts_combo_river_1d_hyperparameters.yaml --task binary_hard --task river --optuna-trials 20
