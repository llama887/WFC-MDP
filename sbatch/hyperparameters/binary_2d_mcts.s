#!/bin/bash
#SBATCH --job-name=hyperparams_binary_2d_mcts
#SBATCH --output=hyperparams_binary_2d_mcts_%j.out
#SBATCH --error=hyperparams_binary_2d_mcts_%j.err
...
python core/evolution.py --generations-per-trial 100 --hyperparameter-dir hyperparameters --output-file mcts_binary_2d_hyperparameters.yaml --task binary_hard --optuna-trials 20 --genotype-dimensions 2
