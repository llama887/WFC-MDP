#!/bin/bash
#SBATCH --job-name=baseline_plots_easy
#SBATCH --output=baseline_plots_easy%j.out
#SBATCH --error=baseline_plots_easy%j.err
...
python fi2pop.py   -l hyperparameters/binary_hyperparameters.yaml   --easy   --binary --bar-graph
