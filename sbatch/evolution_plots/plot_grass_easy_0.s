#!/bin/bash
#SBATCH --job-name=plot_grass_easy_0
#SBATCH --output=plot_grass_easy_0_%j.out
#SBATCH --error=plot_grass_easy_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/combo_grass_1d_hyperparameters.yaml --task grass --combo easy --no-random-offspring 
