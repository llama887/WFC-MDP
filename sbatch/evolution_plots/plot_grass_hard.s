#!/bin/bash
#SBATCH --job-name=plot_grass_hard
#SBATCH --output=plot_grass_hard_%j.out
#SBATCH --error=plot_grass_hard_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_1d_hyperparameters.yaml --task grass --combo hard --debug
