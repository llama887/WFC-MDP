#!/bin/bash
#SBATCH --job-name=plot_biomes
#SBATCH --output=plot_biomes_%j.out
#SBATCH --error=plot_biomes_%j.err
...
python plot.py --load-hyperparameters hyperparameters/biomes_1d_hyperparameters.yaml --task biomes --genotype-dimensions 2
