#!/bin/bash
#SBATCH --job-name=plot_binary_easy_2d
#SBATCH --output=plot_binary_easy_2d_%j.out
#SBATCH --error=plot_binary_easy_2d_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_2d_hyperparameters.yaml --task binary_easy --genotype-dimensions 2 --debug
