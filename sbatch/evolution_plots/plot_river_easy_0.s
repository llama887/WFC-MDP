#!/bin/bash
#SBATCH --job-name=plot_river_easy_0
#SBATCH --output=plot_river_easy_0_%j.out
#SBATCH --error=plot_river_easy_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/combo_river_1d_hyperparameters.yaml --task river --combo easy --no-random-offspring 
