#!/bin/bash
#SBATCH --job-name=plot_river_easy
#SBATCH --output=plot_river_easy_%j.out
...
python plot.py --load-hyperparameters hyperparameters/binary_1d_hyperparameters.yaml --task river --combo easy --debug
