#!/bin/bash
#SBATCH --job-name=plot_pond_easy
#SBATCH --output=plot_pond_easy_%j.out
#SBATCH --error=plot_pond_easy_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_1d_hyperparameters.yaml --task pond --combo easy --debug
