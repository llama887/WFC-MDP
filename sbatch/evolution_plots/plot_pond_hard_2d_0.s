#!/bin/bash
#SBATCH --job-name=plot_pond_hard_2d_0
#SBATCH --output=plot_pond_hard_2d_0_%j.out
#SBATCH --error=plot_pond_hard_2d_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/combo_pond_2d_hyperparameters.yaml --task pond --combo hard --genotype-dimensions 2 --no-random-offspring 
