#!/bin/bash
#SBATCH --job-name=plot_binary_easy
#SBATCH --output=plot_binary_easy%j.out
#SBATCH --error=plot_binary_easy%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_1d_hyperparameters.yaml --task binary_easy --debug
