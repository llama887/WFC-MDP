#!/bin/bash
#SBATCH --job-name=plot_biomes_0
#SBATCH --output=plot_biomes_0_%j.out
#SBATCH --error=plot_biomes_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/biomes_1d_hyperparameters.yaml --task biomes --genotype-dimensions 2 --no-random-offspring 
