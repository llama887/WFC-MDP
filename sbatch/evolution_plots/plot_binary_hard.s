#!/bin/bash
#SBATCH --job-name=plot_binary_hard
#SBATCH --output=plot_binary_hard%j.out
#SBATCH --error=plot_binary_hard%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_1d_hyperparameters.yaml --task binary_hard --debug
