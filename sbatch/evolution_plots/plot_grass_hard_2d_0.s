#!/bin/bash
#SBATCH --job-name=plot_grass_hard_2d_0
#SBATCH --output=plot_grass_hard_2d_0_%j.out
#SBATCH --error=plot_grass_hard_2d_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/combo_grass_2d_hyperparameters.yaml --task grass --combo hard --genotype-dimensions 2 --no-random-offspring 
