#!/bin/bash
#SBATCH --job-name=plot_pond_hard_0
#SBATCH --output=plot_pond_hard_0_%j.out
#SBATCH --error=plot_pond_hard_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/combo_pond_1d_hyperparameters.yaml --task pond --combo hard --no-random-offspring 
