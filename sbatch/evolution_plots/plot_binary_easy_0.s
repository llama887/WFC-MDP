#!/bin/bash
#SBATCH --job-name=plot_binary_easy_0
#SBATCH --output=plot_binary_easy_0_%j.out
#SBATCH --error=plot_binary_easy_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_1d_hyperparameters.yaml --task binary_easy --no-random-offspring 
