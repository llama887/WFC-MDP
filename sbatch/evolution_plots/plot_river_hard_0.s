#!/bin/bash
#SBATCH --job-name=plot_river_hard_0
#SBATCH --output=plot_river_hard_0_%j.out
#SBATCH --error=plot_river_hard_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/combo_river_1d_hyperparameters.yaml --task river --combo hard --no-random-offspring 
