#!/bin/bash
#SBATCH --job-name=plot_pond_hard_2d
#SBATCH --output=plot_pond_hard_2d_%j.out
#SBATCH --error=plot_pond_hard_2d_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_2d_hyperparameters.yaml --task pond --combo hard --genotype-dimensions 2 --debug
