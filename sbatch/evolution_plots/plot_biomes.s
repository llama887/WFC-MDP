#!/bin/bash
#SBATCH --job-name=plot_biomes_2d
#SBATCH --output=plot_biomes_2d_%j.out
#SBATCH --error=plot_biomes_2d_%j.err
...
python plot.py --load-hyperparameters hyperparameters/biomes_1d_hyperparameters.yaml --task biomes 
