#!/bin/bash
#SBATCH --job-name=plot_binary_hard_2d_0
#SBATCH --output=plot_binary_hard_2d_0_%j.out
#SBATCH --error=plot_binary_hard_2d_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_2d_hyperparameters.yaml --task binary_hard --genotype-dimensions 2 --no-random-offspring 
