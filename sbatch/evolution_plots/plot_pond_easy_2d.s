#!/bin/bash
#SBATCH --job-name=plot_pond_easy_2d
#SBATCH --output=plot_pond_easy_2d_%j.out
#SBATCH --error=plot_pond_easy_2d_%j.err
...
python plot.py --load-hyperparameters hyperparameters/combo_pond_2d_hyperparameters.yaml --task pond --combo easy --genotype-dimensions 2
