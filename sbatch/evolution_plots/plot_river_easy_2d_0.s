#!/bin/bash
#SBATCH --job-name=plot_river_easy_2d_0
#SBATCH --output=plot_river_easy_2d_0_%j.out
#SBATCH --error=plot_river_easy_2d_0_%j.err
...
python plot.py --load-hyperparameters hyperparameters/combo_river_2d_hyperparameters.yaml --task river --combo easy --genotype-dimensions 2 --no-random-offspring 
