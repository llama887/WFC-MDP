#!/bin/bash
#SBATCH --job-name=plot_river_hard_2d
#SBATCH --output=plot_river_hard_2d_%j.out
#SBATCH --error=plot_river_hard_2d_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_2d_hyperparameters.yaml --task river --combo hard --genotype-dimensions 2 --debug
