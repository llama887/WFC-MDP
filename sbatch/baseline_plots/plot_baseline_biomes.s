#!/bin/bash
#SBATCH --job-name=plot_biomes_baseline
#SBATCH --output=plot_biomes_baseline_%j.out
#SBATCH --error=plot_biomes_baseline_%j.err
...
python plot.py --load-hyperparameters hyperparameters/baseline_biomes_hyperparameters.yaml --task biomes --method baseline
