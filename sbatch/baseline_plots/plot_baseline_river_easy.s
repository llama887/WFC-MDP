#!/bin/bash
#SBATCH --job-name=plot_river_easy_baseline
#SBATCH --output=plot_river_easy_baseline_%j.out
#SBATCH --error=plot_river_easy_baseline_%j.err
...
python plot.py --load-hyperparameters hyperparameters/baseline_combo_river_hyperparameters.yaml --task river --combo easy --debug --method baseline
