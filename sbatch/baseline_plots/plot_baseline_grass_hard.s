#!/bin/bash
#SBATCH --job-name=plot_grass_hard_baseline
#SBATCH --output=plot_grass_hard_baseline_%j.out
#SBATCH --error=plot_grass_hard_baseline_%j.err
...
python plot.py --load-hyperparameters hyperparameters/baseline_combo_grass_hyperparameters.yaml --task grass --combo hard --method baseline
