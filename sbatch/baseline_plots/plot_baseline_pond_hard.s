#!/bin/bash
#SBATCH --job-name=plot_pond_hard_baseline
#SBATCH --output=plot_pond_hard_baseline_%j.out
#SBATCH --error=plot_pond_hard_baseline_%j.err
...
python plot.py --load-hyperparameters hyperparameters/baseline_combo_pond_hyperparameters.yaml --task pond --combo hard --debug --method baseline
