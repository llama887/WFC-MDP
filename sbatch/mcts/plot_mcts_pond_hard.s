#!/bin/bash
#SBATCH --job-name=plot_pond_hard_mcts
#SBATCH --output=plot_pond_hard_mcts_%j.out
#SBATCH --error=plot_pond_hard_mcts_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_hyperparameters.yaml --task pond --combo hard --debug --method mcts
