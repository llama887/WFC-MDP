#!/bin/bash
#SBATCH --job-name=plot_pond_easy_mcts
#SBATCH --output=plot_pond_easy_mcts_%j.out
#SBATCH --error=plot_pond_easy_mcts_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_hyperparameters.yaml --task pond --combo easy --debug --method mcts
