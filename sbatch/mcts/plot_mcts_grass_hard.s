#!/bin/bash
#SBATCH --job-name=plot_grass_hard_mcts
#SBATCH --output=plot_grass_hard_mcts_%j.out
#SBATCH --error=plot_grass_hard_mcts_%j.err
...
python plot.py --load-hyperparameters hyperparameters/binary_hyperparameters.yaml --task grass --combo hard --debug --method mcts
