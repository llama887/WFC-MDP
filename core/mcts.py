...
if __name__ == "__main__":
    ...
    # Only initialize rendering for the final visualization
    if best_action_sequence:
        # Create a fresh environment just for rendering
        ...
        render_env.tile_images = load_tile_images()
        render_env._init_display()
        ...
        render_env.save_render(output_path)
        print(f"Saved solution visualization to {output_path}")
        pygame.quit()
